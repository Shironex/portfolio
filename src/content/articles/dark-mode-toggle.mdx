...
date: "2024-12-15"
excerpt: "As a web developer, you may be wondering how to create a dark mode toggle for your web application. In this tutorial, we will explore how to implement a dark mode toggle with Next.js and Tailwind CSS."
tags: ["tailwindcss", "css", "frontend"]
readTime: "5 min read"
image: 'https://images.unsplash.com/photo-1607799632518-da91dd151b38?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&h=400'
---
...
<html>
  ...
  <body>
    <div class="container mx-auto py-4">
      <h1 class="mb-4 text-4xl font-bold">Welcome to my Dark Mode Toggle!</h1>
      <p class="text-lg">
